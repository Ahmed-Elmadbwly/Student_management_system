    ...
    <form method="POST" action="{{ route('subLesson.update', [$courseId,$lessonId,$content['subLessonId']]) }}" enctype="multipart/form-data">
        ...
        @else
            ...
            <div class="mb-6">
                ...
                <input type="time" name="time" value="{{ $content['time'] }}" id="time" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:text-white">
            </div>
