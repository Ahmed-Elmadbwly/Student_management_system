        ...
        <table id="classesTable" class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
            ...
            @foreach($answers as $answer)
                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                    ...
                    <td class="px-6 py-4">{{$answer->userId}}</td>
                    <td class="px-6 py-4">{{$answer->score ?$answer->score : "Not review"}}</td>
                    <td class="px-6 py-4">
                        <a href="{{route('teacher.assignments.review',[$assignmentId,$answer->id])}}" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">Review</a>
                    </td>
                </tr>
            @endforeach
            </tbody>
